...
Next.js, TanStack Start, and React Router use client authentication only. Server-side authentication, authenticated SSR, Next.js server providers, and auth middleware are not configured. OAuth, magic links, email verification, password reset, and MFA are outside this starter.
`;
}
